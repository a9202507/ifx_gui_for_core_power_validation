...
class MyMainWindow(QMainWindow, PySide2_DB410_ui.Ui_MainWindow):
    ...
    def load_config(self):
        ...
        try:
            ...
            QMessageBox.about(self,"Warning","the file is incorrect")
    ...
    def update_GUI(self):
        # get GUI import
        self.parameter_main_high_current=self.lineEdit_18.text()
        self.parameter_main_low_current=self.lineEdit_3.text()
        self.parameter_main_gain=self.lineEdit_12.text()
        self.parameter_main_duty_list = eval("["+str(self.lineEdit_13.text())+"]")
        self.parameter_main_slew_nsec=self.lineEdit_14.text()
        self.parameter_main_freq_list = eval("["+str(self.lineEdit_15.text())+"]")
        self.parameter_main_delay_time_sec=self.lineEdit_21.text()
        ...
        self.icc_min = float(self.lineEdit_4.text())
        self.icc_max = float(self.lineEdit_3.text())
...
class MyMainWindow(QMainWindow, Ui_PyQT_IFX_VR14.Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        # set windowTitle
        self.setWindowTitle("IFX PyGUI 2021.12")
    ...
    def fivra_loadline_function(self):
        ...
        self.update_GUI()
        self.runing_items()
        self.rail_name="VCCFAEHVFIVRANW"
        self.vout_list = eval("["+str(self.lineEdit_32.text())+"]")
        self.iout_list = eval("["+str(self.lineEdit_34.text())+"]")
        self.cool_down_delay=int(self.lineEdit_33.text())
    ...
    def set_wp_dc_load_function(self):
        if self.set_wp_dc_load_status == False:
            IFX_VR14_DC_LL.set_wp_inti_DC_load(self.comboBox_2.currentText(), float(self.lineEdit_22.text()),
                                               self.comboBox_3.currentText(), float(self.lineEdit_25.text()),
                                               self.comboBox_4.currentText(), float(self.lineEdit_28.text()),
                                               self.comboBox_5.currentText(), float(self.lineEdit_31.text()),
                                               True)
...
#        IFX_set_wp.ResetAllVectors()
    ...
    def load_report_to_3d_function(self):
        ...
        try:
            ...
            QMessageBox.about(self, "Warning", "The report format does not match")
    ...
    def save_parameter_function(self):
        ...
        if self.tabWidget.currentIndex() == 0:
            ...
            self.parameter_dict = {"set_wp_init_rail_name1": self.comboBox_2.currentText(),
                                   ...
                                   "set_wp_init_rail_load1": self.lineEdit_22.text(),
                                   "set_wp_init_rail_load2": self.lineEdit_25.text(),
                                   "set_wp_init_rail_load3": self.lineEdit_28.text(),
                                   "set_wp_init_rail_load4": self.lineEdit_31.text(),
                                   # vector section
                                   ...
                                   "set_wp_vector_line1_railname": self.comboBox_10.currentText(),
            ...
            self.parameter_dict = {"fivra_3d_target_vout": self.lineEdit_41.text(),
                                   ...
                                   "fivra_3d_loadline_vout_list":self.lineEdit_32.text(),
                                   "fivra_3d_loadline_cool_down_delay":self.lineEdit_33.text(),
                                   "fivra_3d_loadline_iout_list":self.lineEdit_34.text(),
                                   }
            ...
            if self.tabWidget.currentIndex() == 0:
                ...
                if dlg.exec_():
                    ...
                    self.lineEdit_22.setText(
                        json_data["set_wp_init_rail_load1"])
                    self.lineEdit_25.setText(
                        json_data["set_wp_init_rail_load2"])
                    self.lineEdit_28.setText(
                        json_data["set_wp_init_rail_load3"])
                    self.lineEdit_31.setText(
                        json_data["set_wp_init_rail_load4"])
                    #"set_wp_init_rail_load1": self.lineEdit_22.currentText(),
                    ...
                    self.comboBox_19.setCurrentText(
                        json_data["set_wp_vector_line5_command"])
                    self.comboBox_22.setCurrentText(
                        json_data["set_wp_vector_line6_command"])
                    self.comboBox_37.setCurrentText(
                        json_data["set_wp_vector_line7_command"])
                    self.comboBox_48.setCurrentText(
                        json_data["set_wp_vector_line8_command"])
                    self.comboBox_50.setCurrentText(
                        json_data["set_wp_vector_line9_command"])
                    self.comboBox_53.setCurrentText(
                        json_data["set_wp_vector_line10_command"])
                    self.comboBox_55.setCurrentText(
                        json_data["set_wp_vector_line11_command"])
                    self.comboBox_57.setCurrentText(
                        json_data["set_wp_vector_line12_command"])
                ...
                if dlg.exec_():
                    ...
                    self.lineEdit_32.setText(
                        json_data["fivra_3d_loadline_vout_list"])
                    self.lineEdit_33.setText(
                        json_data["fivra_3d_loadline_cool_down_delay"])
                    self.lineEdit_34.setText(
                        json_data["fivra_3d_loadline_iout_list"])
